...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
            ['dinheiro', 'R$ 65,36', ['suco,4', 'salgado,4', 'combo2,2']],
            ['credito', 'R$ 70,86', ['suco,4', 'salgado,4', 'combo2,2']],
            ['debito', 'R$ 68,80', ['suco,4', 'salgado,4', 'combo2,2']],
        ])('compra de múltiplas quantidades em %p deve resultar em %p', validaTeste);

    test.each([
            ['dinheiro', 'R$ 80,75', ['combo1,5', 'combo2,5']],
            ['credito', 'R$ 87,55', ['combo1,5', 'combo2,5']],
            ['debito', 'R$ 85,00', ['combo1,5', 'combo2,5']],
        ])('compra de múltiplas quantidades em %p deve resultar em %p', validaTeste);

        test.each([
            ['chantily com combo2', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo2,1','chantily,1']],
            ['queijo com combo1', 'credito', 'Item extra não pode ser pedido sem o principal', ['combo1,1','queijo,1']],
        ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
            validaTeste(formaDePagamento, resultadoEsperado, itens));
});
